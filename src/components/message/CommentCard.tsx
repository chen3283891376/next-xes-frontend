...
import { Avatar, Badge, Button, Card, Notification, Tooltip } from '@douyinfe/semi-ui-19';
...
const CommentCard = ({
    ...
    return (
        <Card className={className} style={{ display: isShow ? 'block' : 'none' }}>
            <div className="flex items-center justify-between" onClick={needRead ? onClickRead : () => {}}>
                <Badge type="danger" style={{ display: !needRead ? 'none' : 'inline-block' }} position="leftTop" dot>
